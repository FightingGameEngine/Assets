...
[State -1]
type = ChangeState
value = 1500 ; numero do state no cns
...
Agora embaixo disto é para o seu char voar durante o pulo
;Fly
[State -1]
type = ChangeState
value = 1510 ; numero do state no cns
triggerall = command = "fly" ; comando lá de cima
