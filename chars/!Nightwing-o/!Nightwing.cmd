...
;---------------------------------------------------------------------------
; Basic button commands (required by engine — not auto-generated)
[Command]
name = "a"
command = a
time = 1
...
trigger4=(command="holdback"&&command="x")
...
trigger3=(command="z")
trigger4=(stateno=[140,155])
trigger4=(command="holdback"&&command="z")
trigger5=stateno=5210
trigger5=(command="z")
...
trigger3=(command="a")
trigger4=(stateno=[140,155])
trigger4=(command="holdback"&&command="a")
trigger5=stateno=5210
trigger5=(command="a")
trigger6=MoveContact&&StateNo=600
ignorehitpause=1
...
trigger3=(command="c")
trigger4=(stateno=[140,155])
trigger4=(command="holdback"&&command="c")
trigger5=stateno=5210
trigger5=(command="c")
trigger6=MoveContact&&StateNo=[600,610]
trigger7=MoveContact&&StateNo=[630,640]
...
trigger1 = command = "holdback" && movetype !=H
trigger1 = ctrl && StateNo !=[120,160]
value = 120
;=======================================
;Stand to Crouch
[State -1, Crouch]
