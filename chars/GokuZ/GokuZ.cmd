...
;Desperate - Garlick gun (normal)/fusion (ssj)
[State -1, ]
type = ChangeState
value = ifelse(var(9)=0,3300,3350)
triggerall = command = "garlick"
triggerall = power >= 3000
triggerall = life <= 200
trigger1 = (ctrl) && (statetype = S)
trigger2 = stateno = 200 && MoveContact
